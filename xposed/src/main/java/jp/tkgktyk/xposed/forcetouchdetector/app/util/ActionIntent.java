...
/**
 * Created by tkgktyk on 2015/06/21.
 */
public class ActionIntent {
    ...
    public static String getAppName(Context context, Intent intent) {
        String name;
        if (intent == null) {
            name = context.getString(R.string.none);
    ...
    public static String getPackageName(Context context, String uri) {
        return getPackageName(context, getIntent(uri));
    }
