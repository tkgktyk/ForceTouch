 ...
 */
public class LargeThresholdActivity extends AppCompatActivity {
    ...
    protected String getThresholdKey() {
        return getString(R.string.key_large_touch_threshold);
    }

    protected String getThresholdChargingKey() {
        return getString(R.string.key_large_touch_threshold_charging);
    }
...
//        return sum / mAvePressureList.size();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_large_threshold);
